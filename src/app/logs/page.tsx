  ...
  const moveMonth = (amount: number) => {
    const newDate =
      amount > 0
        ...
        : subMonths(currentDate, Math.abs(amount));
          ...
          return (
            ...
            >
              ...
              <div className="h-4 mt-1 flex items-center justify-center gap-1">
                ...
                {record?.image && (
                  <img src={record.image} alt="stamp" className="w-4 h-4" />
                )}
                {!icon && !record?.image && <div className="w-4 h-4 invisible" />}
              </div>
            </div>
          );
        })}
